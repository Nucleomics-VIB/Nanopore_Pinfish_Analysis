...
printGFFclass <- function(usegffclass) {
  ...
  kable(head(gffCoords, 20), format="pandoc", caption=paste("Table summarising the ", mess, tlen, " transcripts identified by the Pinfish that correspond to GffCompare class \"",usegffclass,"\"",sep=""))
